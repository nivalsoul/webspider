...
public class Tuicool {
    ...
    static String[] urls = { "http://www.tuicool.com/ah/0", "http://www.tuicool.com/ah/101000000",
            "http://www.tuicool.com/ah/101040000", "http://www.tuicool.com/ah/101050000",
    ...
    private static void getPage(String url, int k) throws Exception {
        ...
        Elements articles = doc.select("div.list_article_item");
        System.out.println("访问：" + url);
        System.out.println("文章数：" + articles.size());
        for (int i = 0; i < articles.size(); i++) {
            Element article = articles.get(i);
            Element titleLink = article.select("div.title a").first();
